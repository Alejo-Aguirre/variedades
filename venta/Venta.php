...
class Venta {
    ...
    public function obtenerNuevoId() {
        try {
            ...
            $sql = "BEGIN obtener_nuevo_id(:nuevo_id); END;";
    ...
    public function crearVenta($id, $nombre, $fecha, $producto, $precio) {
        try {
            $sql = "INSERT INTO ventas (ID, Nombre, Fecha, Producto, Precio) VALUES (:id, :nombre, TO_DATE(:fecha, 'DD-MON-YYYY'), :producto, :precio)";
            $stmt = $this->conn->prepare($sql);
