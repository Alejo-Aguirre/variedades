...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    include '/../model/Compra.php'; // Ruta correcta al archivo Venta.php
    $modelo = new Compra(); // Crear una instancia de la clase Venta
    ...
    if ($nombre && $fecha && $producto && $precio) {
        ...
        $guardado = $modelo->crearCompra($id, $nombre, $fecha, $producto, $precio);
